...
public class MainActivity extends AppCompatActivity {
    ...
    ProgressBar progress_indication;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress_indication = (ProgressBar) findViewById(R.id.pb_loading_indication);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progress_indication.setVisibility(View.VISIBLE);
        }
        @Override
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            progress_indication.setVisibility(View.INVISIBLE);
            if (weatherData != null) {
