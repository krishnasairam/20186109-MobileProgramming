...
public class MainActivity extends AppCompatActivity implements
    ...
    /** Get the views **/
    private TextView mWaterCountDisplay = (TextView) findViewById(R.id.tv_water_count);
    private TextView mChargingCountDisplay = (TextView) findViewById(R.id.tv_charging_reminder_count);
    private ImageView mChargingImageView = (ImageView) findViewById(R.id.iv_power_increment);
